...
pAnim->UpdateLinkDescription (0, 7, oss.str ());
pAnim->UpdateLinkDescription (0, 8, oss.str ());
pAnim->UpdateLinkDescription (0, 9, oss.str ());
pAnim->UpdateLinkDescription (0, 10, oss.str ());
pAnim->UpdateLinkDescription (0, 11, oss.str ());
...
static uint32_t currentresourceId = resourceId2;
static uint32_t currentresourceId = resourceId3;
static uint32_t currentresourceId = resourceId4;
static uint32_t currentresourceId = resourceId5;
static uint32_t currentresourceId = resourceId6;
...
std::string animFile = "ucoop4.xml";

CommandLine cmd (__FILE__);
  cmd.AddValue ("numberOfNodes", "Number of eNodeBs", numberOfNodesENB);
...
Ptr<LteHelper> = CreateObject<LteHelper> ();
...
lteHelper->SetFadingModelAttribute ("RbNum", TimeValue (Seconds (100)));

lteHelper->SetEnbDeviceAttribute ("DlEarfcn", uintegerValue (100));
lteHelper->SetEnbDeviceAttribute ("UlEarfcn", uintegerValue (10100));

Ptr<PointToPointEpcHelper> epcHelper = CreateObject<PointToPointHelper> ();
...
Ptr<GridBuildingAllocator> grigBuildingAllocator;
grigBUildingAllocator = CreateObject<GridBuildingAllocator> ();
...
serverApps.Add(ulPacketSinkHelper.Install (remoteHostt));
serverApps.Add(packetSinkHelper.Install (ueNodes.Get(u)));

UdpClientHelper dlClient (ueIpIface.GetAddress (u), dlPort);
dlClient.SetAttribute("Interval", TimeValue (MilliSeconds(interPacketInterval)));
dClient.SetAttribute ("MaxPackets", UintegerValue(1000000));
...
clientApps.Add (dClient.Install (remoteHost));
clientApps.Add (uClient.Install (ueNodes.Get(u)));
if ((u+1) < ueNodes>GetN ())
{
...
Config::SetDefault ("ns3::LteAnc::AmcModel", EnumValue (LteAmc::PiroEW2010));
Config::SetDEfault ("ns3::LteAnc::AmcModel", EnumValue (LteAmc::MiErrorModel));
Config::SetDefault ("ns3::LteAnc::Ber", DoubleValue (0.00005));
...
resourceId2 = pAnim->AddResource ("/home/dblessed/Desktop/bake/source/ns-3-dev/scratch/ue.png");
resourceId2 = pAnim->AddResource ("/home/dblessed/Desktop/bake/source/ns-3-dev/scratch/enodeb.png");
resourceId2 = pAnim->AddResource ("/home/dblessed/Desktop/bake/source/ns-3-dev/scratch/pgw.png");
resourceId2 = pAnim->AddResource ("/home/dblessed/Desktop/bake/source/ns-3-dev/scratch/server.png");
resourceId2 = pAnim->AddResource ("/home/dblessed/Desktop/bake/source/ns-3-dev/scratch/ue.png");
resourceId2 = pAnim->AddResource ("/home/dblessed/Desktop/bake/source/ns-3-dev/scratch/ue.png");
//nim->SetBackgroundImage (
